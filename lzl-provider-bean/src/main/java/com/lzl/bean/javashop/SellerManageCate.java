...
public class SellerManageCate implements Serializable{
    ...
    /** 商家id */
    private java.lang.Integer seller;
    ...
    public String toString() {
		return  "Id="  + id +";"+  "Seller="  + seller +";"+  "CreateId="  + createId +";"+  "CreateTime="  + createTime +";"+  "ProductCateId="  + productCateId +";"+  "ProductCateName="  + productCateName +";"+  "State="  + state +";"+  "OptId="  + optId +";"+  "OptTime="  + optTime +";"+  "StopId="  + stopId +";"+  "StopTime="  + stopTime +";"+  "StopReason="  + stopReason ; 
    }
}